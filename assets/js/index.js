document.addEventListener("DOMContentLoaded", async function () {
  ...
  let deals =
    (offerData || []).map((o) => ({
      ...
      roofTech: o.roof_tech,
      areaM2: o.area_m2,
      valueNet: o.value_net,
      ...
      location: o.location,
      investorType: o.investor_type,
      objectType: o.object_type,
      structureType: o.structure_type,
      insulationType: o.insulation_type,
  ...
  if (!tableBody) return;
        ...
        if (addOfferForm) {
          addOfferForm.addEventListener("submit", async (e) => {
            e.preventDefault();
            const payload = {
              stage_id: document.getElementById("offer-stage").value,
              project_name: document.getElementById("offer-name").value,
              company_id: null,
              contact_id: null,
              roof_tech:
              ...
              investor_type:
                document.getElementById("offer-investor-type").value,
              object_type: document.getElementById("offer-object-type").value,
              structure_type:
            ...
            if (error) {
              ...
              showToast("Błąd podczas dodawania oferty");
              return;
            }
            deals.push({
              ...data,
              ...
              company: "",
              roofTech: data.roof_tech,
              areaM2: data.area_m2,
              valueNet: data.value_net,
              ...
              insulationType: data.insulation_type,
